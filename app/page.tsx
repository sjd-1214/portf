...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-10 pt-48 pb-24 relative">
        ...
        {/* Hero Section */}
        <section className="min-h-[85vh] flex flex-col justify-center relative mb-40">
          ...
          <motion.h1 
            ...
            className="text-7xl md:text-[10rem] font-black tracking-tighter leading-[0.8] mb-24 max-w-6xl uppercase select-none relative z-10"
          >
            THE CONTROL <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start relative">
            ...
            >
              <p className="text-2xl text-[var(--muted)] max-w-2xl mb-16 leading-tight font-medium tracking-tight">
              ...
              <div className="flex flex-wrap gap-10">
                ...
                >
                  <a href="#work" className="bg-white text-black px-12 py-6 rounded-full font-black text-xl flex items-center gap-4 hover:scale-105 transition-all duration-500 shadow-[0_0_40px_rgba(255,255,255,0.2)]">
                    ENTER_DASHBOARD <ArrowRight className="h-6 w-6" />
                  </a>
                </motion.div>
                <div className="flex items-center gap-4 text-frizz py-4">
        ...
        {/* Technical Stack */}
        <section className="py-32 mb-48 border-y border-white/5">
           <div className="flex flex-col md:flex-row justify-between gap-24">
              <div className="flex-1">
                 <h2 className="text-5xl font-black tracking-tighter uppercase mb-16 italic">System_Stack</h2>
              ...
              <div className="flex-1 max-w-md flex items-center">
                 <div className="glass-panel p-10 rounded-[3rem] border border-[var(--accent)]/10 shadow-[0_0_50px_rgba(197,160,89,0.05)]">
                    <h4 className="text-3xl font-black italic mb-8 uppercase tracking-tighter text-[var(--accent)]">DevOps_Mandate</h4>
                    <p className="text-lg text-[var(--muted)] font-medium leading-relaxed mb-10 tracking-tight">
                       High-performance systems require high-performance thinking. My engineering philosophy is built on **Zero-Downtime Architecture** and **Elastic Scalability**.
                    </p>
                    <div className="flex flex-wrap gap-3">
                       {['GIT_OPS', 'CI_CD', 'SEC_OPS', 'SRE'].map(tag => (
                          <span key={tag} className="text-[9px] font-black tracking-[0.3em] px-4 py-1.5 bg-white/5 rounded-full border border-white/10 uppercase">{tag}</span>
                       ))}
                    </div>
                 </div>
              </div>
        ...
        <section id="work" className="mb-48">
          <div className="mb-24 flex justify-between items-end">
             <div>
                <h2 className="text-6xl md:text-8xl font-black tracking-tighter uppercase italic mb-6">Deployments.</h2>
                <p className="text-xl text-[var(--muted)] max-w-2xl font-medium tracking-tight opacity-60">Selected architectural achievements.</p>
             </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <motion.div 
              ...
              className="md:col-span-12 group glass-panel rounded-[3.5rem] p-16 overflow-hidden min-h-[550px] border border-white/5 flex flex-col md:flex-row gap-16 relative"
            >
  ...
  eks_managed_node_groups = {
    standard = {
      ...
      max_size = 2400
            ...
            <motion.div 
              whileHover={{ scale: 0.995 }}
              className="md:col-span-6 rounded-[3rem] glass-panel p-12 flex flex-col justify-between group border border-white/5"
            >
               <div>
            ...
            <motion.div 
              whileHover={{ scale: 0.995 }}
              className="md:col-span-12 rounded-[3rem] glass-panel p-12 flex flex-col md:flex-row justify-between items-center group border border-white/5 min-h-[300px]"
            >
               <div className="flex-1">
        ...
        {/* Footer */}
        <footer id="contact" className="py-48 text-center border-t border-white/10 relative overflow-hidden">
           <div className="relative z-10">
              <span className="text-frizz text-[var(--accent)] mb-12 block tracking-[0.6em]">Initialize_Handshake</span>
              <h3 className="text-6xl md:text-[11rem] font-black tracking-tighter leading-none mb-24 uppercase select-none">
              ...
              <div className="flex flex-col gap-12 items-center">
                 <motion.div whileHover={{ scale: 1.05 }}>
                    <a href="mailto:sjdgithub1214@gmail.com" className="text-2xl md:text-6xl font-mono font-black border-b-8 border-[var(--accent)] pb-6 hover:text-[var(--accent)] transition-colors tracking-tighter">
